...
<div class="top">
  <div class="bar white" id="navBar">
    <a href="/main" class="left wide button">따릉따릉이</a>
	...
	<div id="layer"></div>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i
									...
									<input type="text" class="form-control" name="id" id="id" placeholder="Enter your Email" required/>
							</div>
						</div>
					</div>
		...
		<div id="joinModal">
			<div class="main-login main-center">
				<form id="joinForm myForm" class="form-horizontal" method="post" action="">
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
									...
									placeholder="Enter your Email" oninput="checkId()" required/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"><i
									class="fa fa-lock fa-lg" aria-hidden="true"></i></span> <input
									type="password" class="form-control" name="repwd" id="repwd"
									placeholder="Confirm your Password" oninput="checkPwd()" required />
							</div>
						</div>
					</div>
						...
						<div class="cols-sm-10">
							<div class="input-group">
								<span class="input-group-addon"> <i
									...
									<input type="text"	id="sample6_postcode" class="form-control" style="width: 52%" placeholder="우편번호" required> 
									<input type="button" class="btn" style="margin-left: 5%; font-size: 12px" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
									<input type="text" style="font-size: 10px;" class="form-control" id="sample6_address" placeholder="주소" required>
							</div>
						</div>
					</div>
					...
					<div class="form-group ">
						...
						<button id="update_submit" type="submit" class="btn btn-success display_none">update</button>
						<button type="button" class="btn btn-danger">Cancel</button>						
					</div>
				</form>
			</div>
