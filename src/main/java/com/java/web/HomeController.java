...
import com.java.web.anaylsis.Reducer;
...
public class HomeController {
	...
	public void mrCall(HttpServletRequest req,HttpServletResponse res) throws Exception{
		...
		if(check == 1 || check == 2) {		//연령대별
			job.setMapperClass(MapperAge.class); 
			
		} else if(check == 3 || check == 4) {	// 성별
	...
	public void dfs(HttpServletRequest req , HttpServletResponse res) throws Exception{
